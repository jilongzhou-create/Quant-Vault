...
@register_allocator
class V6RiskParityDoubleLeverage(BaseAllocator):
    name = "V6RiskParityDoubleLeverage"
    description = "V4 Risk Parity + 2x overall leverage (Pro-Rata capped at 1.0)"

    LEVERAGE_SCALAR_FULL = 2.5
    LEVERAGE_SCALAR_DEGRADED = 1.5
    MAX_WEIGHT_PER_ASSET = 0.45
    OVERALL_MULTIPLIER = 2.0
